...
def discount_handler(message):
    bot.send_message(
        message.chat.id,
        "*Ми високо цінуємо вклад військовослужбовців у нашу безпеку та добробут країни. *💙💛\n"
        "Завдяки їхній мужності та відвазі ми маємо можливість жити і відпочивати у мирній та безпечній атмосфері. 🕊️\n"
        "Тому ми із вдячністю пропонуємо знижку -15% для військовослужбовців за пред'явлення УБД. \n"
        "Ця знижка — наша маленька подяка за їхній подвиг та незламний дух. 🙏\n\n"
        "*Знижка діє тільки для особи, яка пред’явила документ, що підтверджує статус військовослужбовця, та поширюється на проживання в апартаментах та будинках.* \n\n"
        "• ☝️ *ВАЖЛИВО!*\n"
        "• Скористайтеся нашою пропозицією прямо зараз!\n"
        "• З питань бронювання звертайтесь за телефоном:\n"
        " 📱+38 073 777 81 44 або 📱+38 067 777 81 44\n\n"
        "_У разі дострокового виїзду гостя плата за невикористані ночі не повертається._\n"
        "❗️Знижка не поширюється на раніше оформлені та підтверджені бронювання.\n"
        "❗️Зазначені знижки не підсумовуються з іншими акціями та спеціальними пропозиціями.\n"
        "❗️Переваги програми не розповсюджуються на бронювання, здійснені на сайтах-посередниках, через тур-агентів або інших представників.",
        parse_mode="Markdown"
    )
