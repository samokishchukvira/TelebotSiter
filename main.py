...
def discount_handler(message):
    bot.send_message(
        ...
        "* Знижка не поширюється на раніше оформлені та підтверджені бронювання.\n"
        "** Зазначені знижки не підсумовуються з іншими акціями та спеціальними пропозиціями.\n"
        "*** Переваги програми не розповсюджуються на бронювання, здійснені на сайтах-посередниках, через тур-агентів або інших представників.",
        parse_mode="Markdown"
    )
